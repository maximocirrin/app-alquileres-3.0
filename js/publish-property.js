                    ...
                    <div id="wizard-step-1-container"
                        ...
                        <div
                            ...
                            <div id="step-operacion" class="block">
                                <form id="form-principales" name="form-principales" class="space-y-8" novalidate autocomplete="off">
                                    <!-- Tipo de operación -->
                                    <div class="space-y-4">
                                        <label
                                    ...
                                    <!-- Subtipo de propiedad -->
                                     <div id="container-subtipo-propiedad" class="space-y-4">
                                         <label
                                     ...
                                     <!-- Número de local (condicional para Subtipo En galería) -->
                                     <div id="container-numero-local" class="hidden space-y-4">
                                         <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                             ...
                                             <div class="space-y-2">
                                                 ...
                                                 <div class="relative">
                                                     <input type="text" id="sector-local" name="sector_galeria" autocomplete="off" placeholder="Ej: Planta baja"
                                    ...
                                    <div class="mt-8">
                                        <div class="flex items-center gap-2 mb-4 px-1">
                                            ...
                                            <span id="map-address-label"
                                                class="font-body text-secondary dark:text-[#c7c6c6] text-sm md:text-base">Av. San Martín 123, Ciudad de Mendoza, Mendoza</span>
                                        </div>
                                ...
                                <form id="form-caracteristicas" class="space-y-12" novalidate>
                                    ...
                                    <div class="space-y-6">
                                        <div class="flex items-center justify-between gap-4 flex-wrap">
                                            <label
                                                class="flex-1 min-w-0 font-headline font-bold text-on-background dark:text-[#f1f1f1] text-lg md:text-xl">Ambientes
                                                <span
                                                    class="text-secondary dark:text-[#c7c6c6] text-base font-normal">(opcional)</span></label>
                                            <div style="display: grid; grid-template-columns: 40px 32px 40px; align-items: center; justify-content: space-between; width: 140px; min-width: 140px; padding: 4px; border-radius: 9999px; box-sizing: border-box; flex-shrink: 0;"
                                                class="bg-surface-container-high dark:bg-[#282828] border border-outline-variant/30 dark:border-white/5">
                                                <button type="button"
                                                    style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; border-radius: 9999px; flex-shrink: 0;"
                                                    class="text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors"
                                                ...
                                                <input type="number" id="ambientes-new"
                                                    style="width: 32px; min-width: 32px; max-width: 32px; text-align: center; background: transparent !important; box-shadow: none !important; border: none !important; padding: 0; appearance: none; -webkit-appearance: none; flex-shrink: 0;"
                                                    class="text-on-background dark:text-[#f1f1f1] font-headline font-bold text-lg focus:ring-0 select-none"
                                                    value="0" readonly>
                                                <button type="button"
                                                    style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; border-radius: 9999px; flex-shrink: 0;"
                                                    class="text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors"
                                        ...
                                        <div class="flex items-center justify-between gap-4 flex-wrap">
                                            <label
                                                class="flex-1 min-w-0 font-headline font-bold text-on-background dark:text-[#f1f1f1] text-lg md:text-xl">Dormitorios
                                                <span
                                                    class="text-secondary dark:text-[#c7c6c6] text-base font-normal">(opcional)</span></label>
                                            <div style="display: grid; grid-template-columns: 40px 32px 40px; align-items: center; justify-content: space-between; width: 140px; min-width: 140px; padding: 4px; border-radius: 9999px; box-sizing: border-box; flex-shrink: 0;"
                                                class="bg-surface-container-high dark:bg-[#282828] border border-outline-variant/30 dark:border-white/5">
                                        ...
                                        <div class="flex items-center justify-between gap-4 flex-wrap">
                                            <label
                                                class="flex-1 min-w-0 font-headline font-bold text-on-background dark:text-[#f1f1f1] text-lg md:text-xl">Baños
                                                <span
                                                    class="text-secondary dark:text-[#c7c6c6] text-base font-normal">(opcional)</span></label>
                                            <div style="display: grid; grid-template-columns: 40px 32px 40px; align-items: center; justify-content: space-between; width: 140px; min-width: 140px; padding: 4px; border-radius: 9999px; box-sizing: border-box; flex-shrink: 0;"
                                                class="bg-surface-container-high dark:bg-[#282828] border border-outline-variant/30 dark:border-white/5">
                                    ...
                                    <div id="mascotas-detalles-container" class="space-y-8 hidden transition-all duration-300">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                <!-- Gato -->
                                                <div class="flex items-center justify-between p-2.5 sm:p-4 rounded-xl bg-surface-container-lowest dark:bg-[#0c0c0e] border border-outline-variant/30 dark:border-white/5 min-w-0 gap-2 sm:gap-3">
                                                    <div class="flex items-center gap-1.5 sm:gap-3 min-w-0">
                                                        <svg class="w-5 h-5 sm:w-6 sm:h-6 text-secondary dark:text-[#c7c6c6] fill-current shrink-0" viewBox="0 0 24 24"><path d="M4 3l4 4.5C9.3 7 10.6 6.5 12 6.5s2.7.5 4 1L20 3l-1.2 7.2C20.2 11.9 21 13.8 21 16c0 3.9-4 7-9 7s-9-3.1-9-7c0-2.2.8-4.1 2.2-5.8L4 3zm4.5 11c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5 1.5-.7 1.5-1.5-.7-1.5-1.5-1.5zm7 0c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5 1.5-.7 1.5-1.5-.7-1.5-1.5-1.5zm-3.5 3c-1.2 0-2 .5-2 1h4c0-.5-.8-1-2-1z"/></svg>
                                                        <span class="font-headline font-semibold text-on-background dark:text-[#f1f1f1] text-xs sm:text-sm leading-tight whitespace-normal">Gatos</span>
                                                    </div>
                                                    <div class="flex items-center gap-1 sm:gap-2 bg-surface-container-high dark:bg-[#282828] p-1 rounded-full border border-outline-variant/30 dark:border-white/5 shrink-0">
                                                        <button type="button" class="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors shrink-0" onclick="const i = document.getElementById('cant-gato'); i.value = Math.max(0, parseInt(i.value||0)-1); document.getElementById('cant-gato-display').textContent = i.value;"><span class="material-symbols-outlined text-sm sm:text-base">remove</span></button>
                                                        <span class="w-6 sm:w-8 text-center text-on-background dark:text-[#f1f1f1] font-headline font-bold text-xs sm:text-sm select-none" id="cant-gato-display">0</span>
                                                        <input type="hidden" id="cant-gato" value="0">
                                                        <button type="button" class="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors shrink-0" onclick="const i = document.getElementById('cant-gato'); i.value = parseInt(i.value||0)+1; document.getElementById('cant-gato-display').textContent = i.value;"><span class="material-symbols-outlined text-sm sm:text-base">add</span></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center justify-between p-2.5 sm:p-4 rounded-xl bg-surface-container-lowest dark:bg-[#0c0c0e] border border-outline-variant/30 dark:border-white/5 min-w-0 gap-2 sm:gap-3">
                                                    <div class="flex items-center gap-1.5 sm:gap-3 min-w-0">
                                                        <span class="material-symbols-outlined text-secondary dark:text-[#c7c6c6] shrink-0 text-xl sm:text-[22px]">sound_detection_dog_barking</span>
                                                        <span class="font-headline font-semibold text-on-background dark:text-[#f1f1f1] text-xs sm:text-sm leading-tight whitespace-normal">Perro Pequeño</span>
                                                    </div>
                                                    <div class="flex items-center gap-1 sm:gap-2 bg-surface-container-high dark:bg-[#282828] p-1 rounded-full border border-outline-variant/30 dark:border-white/5 shrink-0">
                                                        <button type="button" class="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors shrink-0" onclick="const i = document.getElementById('cant-perro-pequeno'); i.value = Math.max(0, parseInt(i.value||0)-1); document.getElementById('cant-perro-pequeno-display').textContent = i.value;"><span class="material-symbols-outlined text-sm sm:text-base">remove</span></button>
                                                        <span class="w-6 sm:w-8 text-center text-on-background dark:text-[#f1f1f1] font-headline font-bold text-xs sm:text-sm select-none" id="cant-perro-pequeno-display">0</span>
                                                        <input type="hidden" id="cant-perro-pequeno" value="0">
                                                        <button type="button" class="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors shrink-0" onclick="const i = document.getElementById('cant-perro-pequeno'); i.value = parseInt(i.value||0)+1; document.getElementById('cant-perro-pequeno-display').textContent = i.value;"><span class="material-symbols-outlined text-sm sm:text-base">add</span></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center justify-between p-2.5 sm:p-4 rounded-xl bg-surface-container-lowest dark:bg-[#0c0c0e] border border-outline-variant/30 dark:border-white/5 min-w-0 gap-2 sm:gap-3">
                                                    <div class="flex items-center gap-1.5 sm:gap-3 min-w-0">
                                                        <span class="material-symbols-outlined text-secondary dark:text-[#c7c6c6] shrink-0 text-xl sm:text-[22px]">pets</span>
                                                        <span class="font-headline font-semibold text-on-background dark:text-[#f1f1f1] text-xs sm:text-sm leading-tight whitespace-normal">Perro Grande</span>
                                                    </div>
                                                    <div class="flex items-center gap-1 sm:gap-2 bg-surface-container-high dark:bg-[#282828] p-1 rounded-full border border-outline-variant/30 dark:border-white/5 shrink-0">
                                                        <button type="button" class="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors shrink-0" onclick="const i = document.getElementById('cant-perro-grande'); i.value = Math.max(0, parseInt(i.value||0)-1); document.getElementById('cant-perro-grande-display').textContent = i.value;"><span class="material-symbols-outlined text-sm sm:text-base">remove</span></button>
                                                        <span class="w-6 sm:w-8 text-center text-on-background dark:text-[#f1f1f1] font-headline font-bold text-xs sm:text-sm select-none" id="cant-perro-grande-display">0</span>
                                                        <input type="hidden" id="cant-perro-grande" value="0">
                                                        <button type="button" class="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-on-background dark:text-[#f1f1f1] hover:bg-surface-container-lowest dark:hover:bg-[#0c0c0e] transition-colors shrink-0" onclick="const i = document.getElementById('cant-perro-grande'); i.value = parseInt(i.value||0)+1; document.getElementById('cant-perro-grande-display').textContent = i.value;"><span class="material-symbols-outlined text-sm sm:text-base">add</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
