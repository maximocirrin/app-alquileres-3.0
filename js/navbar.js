    ...
    <div class="relative flex justify-between items-center px-2 sm:px-4 lg:px-6 xl:px-12 h-16 lg:h-20 w-full max-w-[1920px] mx-auto font-['Manrope'] tracking-tight gap-1 sm:gap-2">
        <div class="flex items-center gap-1 sm:gap-3 xl:gap-5 flex-1 max-w-[calc(50%-70px)]">
            ...
            <div class="flex max-xl:hidden items-center gap-2.5 xl:gap-3.5 2xl:gap-5 font-medium">
                ...
                <a href="agentes.html" class="text-zinc-500 dark:text-zinc-300 hover:text-primary dark:hover:text-red-400 transition-colors cursor-pointer text-[13px] xl:text-[13.5px] 2xl:text-[14.5px] font-bold flex items-center gap-1">
                    <span class="material-symbols-outlined text-blue-900 dark:text-blue-400 text-sm">handshake</span> Solicitar Agente
                </a>
            </div>
        </div>
        ...
        <div class="flex items-center gap-1 sm:gap-2 xl:gap-3.5 2xl:gap-5 ml-auto z-20 max-w-[calc(50%-70px)] justify-end">
            ...
            <div id="desktop-auth-container" class="max-xl:hidden flex items-center ml-2 mr-2">
                <div class="auth-ui-state logged-out flex items-center gap-2">
                    <a href="login.html?mode=login" class="text-sm font-bold text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-red-400 transition-colors">Ingresar</a>
                    <a href="login.html?mode=register" class="text-sm font-bold text-white bg-primary dark:bg-red-800 px-4 py-2 rounded-full hover:bg-red-800 dark:hover:bg-red-700 transition-colors shadow-md">Registrarse</a>
                </div>
