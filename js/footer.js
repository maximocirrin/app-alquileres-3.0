(function() {
    ...
    <div class="max-w-[1580px] mx-auto">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-12 pb-12 border-b border-zinc-300/70 dark:border-zinc-800">
            <!-- Col 1: Vivat -->
            <div>
                <h3 class="font-headline text-sm font-extrabold text-on-background dark:text-white mb-5 uppercase tracking-wider">Vivat</h3>
                <nav class="flex flex-col items-start gap-3 font-body text-sm text-zinc-600 dark:text-zinc-400">
                    ...
                    <a href="pasaporte-vivat.html" class="hover:text-primary dark:hover:text-red-400 transition-colors">Pasaporte Vivat</a>
                </nav>
            </div>
            ...
            <div>
                ...
                <div class="flex flex-col items-start gap-4">
                    ...
                    <a href="mailto:soporte@vivat.com.ar" class="font-body text-sm text-zinc-600 dark:text-zinc-400 hover:text-primary dark:hover:text-red-400 transition-colors">Contactar con soporte</a>
                </div>
            </div>
        ...
        <div class="pt-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3.5 flex-wrap">
                <img src="img/logo-vivat-web.svg" alt="Vivat Logo" class="h-8 w-auto object-contain dark:brightness-200 dark:opacity-90" />
                <span class="font-body text-sm text-zinc-500 dark:text-zinc-400">
                    &copy; 2026 Vivat &ndash; Todos los derechos reservados
                </span>
            </div>
        </div>
    </div>
