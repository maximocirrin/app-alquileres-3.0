        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-12 pb-12 border-b border-zinc-300/70 dark:border-zinc-800">
            ...
            <div class="flex flex-col gap-8">
                <div>
                    ...
                    <nav class="flex flex-col items-start gap-3 font-body text-sm text-zinc-600 dark:text-zinc-400">
                        <a href="tu-alquiler.html" class="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Mi Alquiler Activo & Pagos</a>
                        <a href="postulaciones.html" class="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Mis Postulaciones</a>
                        <a href="visitas.html" class="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Visitas Agendadas</a>
